...
class CreateData {
    run(_, connection) {
        return __awaiter(this, void 0, void 0, function* () {
            const password = yield bcrypt_1.default.hash('123456', 6);
            ...
            yield connection
                ...
                .execute();
            const john = yield User_1.default.findOne({ username: 'john' });
            const jane = yield User_1.default.findOne({ username: 'jane' });
            // Create subs
            yield connection
                .createQueryBuilder()
                .insert()
                ...
                .execute();
            const reactJsSub = yield Sub_1.default.findOne({ where: { name: 'reactjs' } });
            const funnySub = yield Sub_1.default.findOne({ where: { name: 'funny' } });
            const iqSub = yield Sub_1.default.findOne({ where: { name: 'InsightfulQuestions' } });
            const oneliners = yield Sub_1.default.findOne({ where: { name: 'oneliners' } });
            // Create posts
            yield connection
                .createQueryBuilder()
                .insert()
            ...
            any advice to help me to take the step?`,
                ...
                .execute();
            const post6 = yield Post_1.default.findOne(6);
            const post7 = yield Post_1.default.findOne(7);
            const post8 = yield Post_1.default.findOne(8);
            const post9 = yield Post_1.default.findOne(9);
            // Create comments
            yield connection
                .createQueryBuilder()
                .insert()
                ...
                .execute();
            const comment1 = yield Comment_1.default.findOne(1);
            const comment2 = yield Comment_1.default.findOne(2);
            // Create votes
            yield connection
                .createQueryBuilder()
                .insert()
